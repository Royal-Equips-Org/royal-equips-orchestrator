...
class ShopifyConnector:
    ...
    async def handle_shopify_query_products(self, arguments: Dict[str, Any]) -> List[TextContent]:
        ...
        try:
            ...
            return [TextContent(
                type="text",
                text=f"Shopify Products Query Result:\n{result}"
            )]
            ...
            return [TextContent(
                type="text",
                text=f"Error querying Shopify products: {str(e)}"
            )]
    
    async def handle_shopify_query_orders(self, arguments: Dict[str, Any]) -> List[TextContent]:
        ...
        try:
            ...
            return [TextContent(
                type="text",
                text=f"Shopify Orders Query Result:\n{result}"
            )]
            ...
            return [TextContent(
                type="text",
                text=f"Error querying Shopify orders: {str(e)}"
            )]
    
    async def handle_shopify_query_customers(self, arguments: Dict[str, Any]) -> List[TextContent]:
        ...
        try:
            ...
            return [TextContent(
                type="text",
                text=f"Shopify Customers Query Result:\n{result}"
            )]
            ...
            return [TextContent(
                type="text",
                text=f"Error querying Shopify customers: {str(e)}"
            )]
    
    async def handle_shopify_mutation(self, arguments: Dict[str, Any]) -> List[TextContent]:
        ...
        try:
            ...
            return [TextContent(
                type="text",
                text=f"Shopify Mutation Result:\n{result}"
            )]
            ...
            return [TextContent(
                type="text",
                text=f"Error executing Shopify mutation: {str(e)}"
            )]

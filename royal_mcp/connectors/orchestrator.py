...
class OrchestratorConnector:
    ...
    async def handle_orchestrator_health(
        ...
        try:
            ...
            return [
                TextContent(
                    type="text", text=f"Error checking orchestrator health: {str(e)}"
                )
            ]

    async def handle_orchestrator_agent_status(
        self, arguments: Dict[str, Any]
    ) -> List[TextContent]:
        ...
        try:
            ...
            return [
                TextContent(
                    type="text", text=f"Orchestrator Agent Status:\n{response_data}"
                )
            ]
    ...
    async def handle_orchestrator_run_agent(
        self, arguments: Dict[str, Any]
    ) -> List[TextContent]:
        ...
        try:
            ...
            if not agent_id or not action:
                return [
                    TextContent(
                        type="text", text="Error: agent_id and action are required"
                    )
                ]
            ...
            result = await self._make_request(
                "POST", endpoint, payload, require_hmac=True
            )
            ...
            return [
                TextContent(
                    type="text", text=f"Error running orchestrator agent: {str(e)}"
                )
            ]

    async def handle_orchestrator_metrics(
        self, arguments: Dict[str, Any]
    ) -> List[TextContent]:
        ...
        try:
            ...
            return [
                TextContent(type="text", text=f"Orchestrator Metrics:\n{response_data}")
            ]
            ...
            return [
                TextContent(
                    type="text", text=f"Error getting orchestrator metrics: {str(e)}"
                )
            ]

    async def handle_orchestrator_logs(
        self, arguments: Dict[str, Any]
    ) -> List[TextContent]:
        ...
        try:
            ...
            return [
                TextContent(type="text", text=f"Orchestrator Logs:\n{response_data}")
            ]
            ...
            return [
                TextContent(
                    type="text", text=f"Error getting orchestrator logs: {str(e)}"
                )
            ]

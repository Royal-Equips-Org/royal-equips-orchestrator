...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler("royal_mcp.log") if os.environ.get("MCP_LOG_FILE") else logging.NullHandler()
    ]
)
...
class RoyalMCPServer:
    ...
    def _register_tools(self) -> None:
            ...
            if hasattr(connector, 'get_tools'):
                ...
                for tool in tools:
                    ...
                    if hasattr(connector, f'handle_{tool_name}'):
                        ...
                        logger.info(f"Registered tool: {tool_name} from {connector_name}")
        ...
        async def handle_tool_call(name: str, arguments: Optional[Dict[str, Any]] = None) -> List[Any]:

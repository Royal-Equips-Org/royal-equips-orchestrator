...
import ModuleScroller from './ModuleScroller'
...
export default function AppLayout() {
  ...
  // Sync route with navigation context
  useEffect(() => {
    const path = location.pathname.slice(1) // Remove leading slash
    const moduleId = path || 'command'
    navigateToModule(moduleId)
  }, [location.pathname, navigateToModule])
    ...
    <MobileShell className="ai-core-root">
      ...
      <div className="ai-core-module-content px-4 sm:px-6 lg:px-16">
        ...
        <div className="rounded-3xl border border-cyan-500/20 bg-black/20 backdrop-blur-2xl p-6">
          {/* This is where each page component will render */}
          <Outlet />
        </div>
      </div>
